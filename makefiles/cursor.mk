...
# Cursor-specific pieces: agents, lifecycle hooks (hooks.json), and the hook
# scripts they call. It also prunes the legacy ~/.cursor layout that predates
# the universal skills setup.
#
...
cursor: cursor-agents cursor-scripts cursor-hooks ai-agents ## Install Cursor agents, hook scripts, hooks + universal skills (~/.agents/skills)
...
.PHONY: cursor cursor-agents cursor-scripts cursor-hooks cursor-clean
