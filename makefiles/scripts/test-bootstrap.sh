...
installer_pattern='get\.volta\.sh|get\.pnpm\.io/install\.sh|bun\.com/install|astral\.sh/uv/install\.sh|opencode\.ai/install|chatgpt\.com/codex/install\.sh|claude\.ai/install\.sh'
