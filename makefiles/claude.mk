...
claude: claude-dirs claude-agents claude-scripts claude-settings ai-shared ai-claude ## Install Claude Code agents, scripts, settings, and skills
...
.PHONY: claude claude-dirs claude-agents claude-scripts claude-settings claude-clean
