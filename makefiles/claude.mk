...
claude-skills: claude-dirs ## Symlink Claude Code skills
	...
	$(call mkdir_safe,${CLAUDE_HOME}/skills/create-pr/references)
	$(call symlink,ai-stuff/codex/skills/create-pr/SKILL.md,${CLAUDE_HOME}/skills/create-pr/SKILL.md)
	$(call symlink,ai-stuff/codex/skills/create-pr/references/commands.md,${CLAUDE_HOME}/skills/create-pr/references/commands.md)
