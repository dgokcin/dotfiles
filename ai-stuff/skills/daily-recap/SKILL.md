...
- Output template: read [daily-recap-output.md](../_shared/templates/daily-recap-output.md) — relative to this skill's directory
...
- **Follow output template** — `../_shared/templates/daily-recap-output.md` (relative to this skill's directory) has all formatting/voice/structure rules
