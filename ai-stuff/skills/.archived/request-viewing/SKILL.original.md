...
- `input[type="email"]`: dgokcin+funda@gmail.com
- `input[type="text"][placeholder*="First"]`: Deniz
- `input[type="text"][placeholder*="Last"]`: Gokcin
- `input[type="tel"]`: +31629778322
- `input[type="text"][placeholder*="Post code"]`: 1013RJ
- `input[type="text"][placeholder*="House number"]`: 423
