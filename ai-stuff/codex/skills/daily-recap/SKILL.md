...
- Tomorrow's date: run `date -v+1d +%Y-%m-%d`
- Existing daily notes: run `ls "/Users/denizgokcin/Library/Mobile Documents/iCloud~md~obsidian/Documents/vault/work/daily notes/" 2>/dev/null`
- Dia context files: run `find "$HOME/Library/Application Support/Dia/User Data/Profile 1/AgentServer/contexts" -name "index.html" -ls 2>/dev/null`
- Output template: [Daily recap template](../_shared/templates/daily-recap-output.md)
...
- **Follow the output template** — read [Daily recap template](../_shared/templates/daily-recap-output.md) for all formatting, voice, and structure rules
